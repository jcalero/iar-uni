...
%Using the light sensors on the robot we calculate the relative angle it should be facing which is then taken as input to the functions which detemine the speed of the individual wheels. 
\section{Methods} 
