...
\label{LDD}
Our robot has 8 sensors detecting levels of light at value range of 0 to 500 arranged as seen in (\emph{figure 3.1}). The higher the intensity of the light the lower the value
