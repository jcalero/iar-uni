...
\label{LDD}
Our robot has 8 sensors detecting levels of light at a value range of 0 to 500, which are arranged as seen in (\emph{figure \ref{img_sensors}}), with 6 sensors in the front and 2 in the back. From this information we ultimately want to estimate a direction the light could be originating from by combining the values and positions of the individual sensors.
