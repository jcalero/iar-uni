function [ particles, bestPos ] = ressample2( particles, sensor, stepmove, map,sigma)
...
[reinitpart , robot]=initialize(floor(0.2*numpart),map); % reinitializes 20 percent of the particles
